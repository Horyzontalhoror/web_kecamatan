...
<nav class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm">
    <div class="max-w-screen-xl mx-auto flex flex-wrap justify-between items-center p-4">
        ...
        <a href="/" class="flex items-center space-x-4 rtl:space-x-reverse">
            <img src="https://upload.wikimedia.org/wikipedia/commons/8/8d/Lambang_Bangkalan.png" class="h-14 sm:h-16"
                alt="Logo" />
            <div>
        ...
        <div class="flex items-center space-x-6 rtl:space-x-reverse text-sm">
            <div class="hidden sm:block text-gray-700 dark:text-white">
                ...
                <div class="flex items-center">
                    ...
                    <a href="mailto:kec.tanjungbumi@bangkalankab.go.id"
                        class="hover:underline">kec.tanjungbumi@bangkalankab.go.id</a>
                </div>
            </div>
            ...
            <a href="{{ route('dashboard') }}">
                <button
                    class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800 transition-all shadow hover:shadow-lg">
                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                            d="M12 20a7.966 7.966 0 0 1-5.002-1.756v-.683c0-1.794 1.492-3.25 3.333-3.25h3.334c1.84 0 3.333 1.456 3.333 3.25v.683A7.966 7.966 0 0 1 12 20ZM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10c0 5.5-4.44 9.963-9.932 10H12C6.438 21.962 2 17.5 2 12Zm10-5a3.25 3.25 0 1 0 0 6.5A3.25 3.25 0 0 0 12 7Z"
                            clip-rule="evenodd" />
                    </svg>
                    Login
                </button>
...
<nav class="bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-sm">
    <div class="max-w-screen-xl mx-auto px-4 py-4">
        <ul class="flex flex-wrap justify-center gap-4 sm:gap-6 text-sm sm:text-base font-medium">
            ...
            <li>
                <a href="{{ route('suratonline.create') }}"
                    class="{{ request()->routeIs('suratonline.create')
                        ? 'text-blue-600 font-semibold'
                        : 'text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400' }} transition">
                    Surat Online
                </a>
